...
function reiniciarJuego(){
    fichasJugador1.innerHTML= `<p>${fichaJugador1}</p><p>${fichaJugador1}</p><p>${fichaJugador1}</p>`;
    fichasJugador2.innerHTML= `<p>${fichaJugador2}</p><p>${fichaJugador2}</p><p>${fichaJugador2}</p>`;
